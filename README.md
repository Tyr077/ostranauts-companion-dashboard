...
Grab the latest **[release zip](https://github.com/Tyr077/ostranauts-companion-dashboard/releases/latest)** — it contains a prebuilt `CompanionServer.dll`, the dashboard, and an `INSTALL.txt` with step-by-step instructions. You only need [BepInEx 5.4.23.5 (x64)](https://github.com/BepInEx/BepInEx/releases) and [Python 3.10+](https://www.python.org/downloads/) installed.
...
Build from source (see below) and place the DLL in the game folder:
